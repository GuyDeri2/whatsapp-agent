...
א) אם כתובת המייל של הלקוח **לא** הוזכרה בשיחה — שאל אותה תחילה: "כדי שנציג יוכל לחזור אליך, מה כתובת המייל שלך?" (הודעה אחת, ללא [PAUSE]).
ב) לאחר שהלקוח נתן את המייל (או אם המייל כבר ניתן קודם) — שלח הודעת סיום מנומסת וסיים בדיוק כך: [PAUSE].
