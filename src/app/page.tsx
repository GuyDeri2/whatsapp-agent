...
const demoTranscript = [
    { speaker: "agent", text: "שלום! תודה שהִתְקַשַּׁרְתְּ לסטודיו לנייל ארט. אני שירה, העוזרת הווירטואלית. במה אוכל לעזור?" },
    { speaker: "customer", text: "היי, רציתי לקבוע תור למניקור ג׳ל" },
    { speaker: "agent", text: "בשמחה! יש לנו פנוי ביום שלישי בשתיים בצהריים או ביום חמישי בעשר בבוקר. מה מתאים לָךְ?" },
    { speaker: "customer", text: "שלישי בשתיים מעולה" },
    { speaker: "agent", text: "מצוין, קבעתי לָךְ תור ליום שלישי בשתיים בצהריים למניקור ג׳ל. אשלח לָךְ אישור בהודעה עם כל הפרטים. יום נעים!" },
];
