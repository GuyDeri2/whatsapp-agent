...
const demoTranscript = [
    ...
    { speaker: "agent", text: "בשמחה! יש לנו פנוי ביום שלישי בשתיים בצהריים או ביום חמישי בעשר בבוקר. מה מתאים לך?" },
    { speaker: "customer", text: "שלישי בשתיים מעולה" },
    { speaker: "agent", text: "מצוין, קבעתי לך תור ליום שלישי בשתיים בצהריים למניקור ג׳ל. אשלח לך אישור בהודעה עם כל הפרטים. יום נעים!" },
];
