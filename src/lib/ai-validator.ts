...
**חריג חשוב:** אם הודעת הלקוח קצרה מאוד (מילה אחת או שתיים) ולא ברורה (כמו "מי", "מה", "הא?", "ok") — תשובה כמו "אפשר לפרט?" או "מעביר לנציג" היא תקינה. אל תדחה בגלל "התעלמות" כשהשאלה עצמה לא ברורה.
